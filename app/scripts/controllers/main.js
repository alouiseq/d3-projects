define(['angular'], function (angular) {
    ...
    angular.module('d3ProjectsApp.controllers.MainCtrl', [])
        .controller('MainCtrl', function () {
            ...
            var fontSize = 12;
            var padding = 10;
            var percentLabelOffset = 20 + fontSize;
            var yOffset = 3;
            var yScaleSLA = 1;
            var yScaleTime = 8;
            ...
            var svgSLA = d3.select('.sla')
                .append('svg')
                    .attr('width', wSLA + percentLabelOffset)
                    .attr('height', hSLA);
            ...
            svgSLA.selectAll('rect')
                ...
                .append('rect')
                    .attr('x', function (d, i) {    // d == data; i == index
                        return i * (wSLA / dataSLA.length) + percentLabelOffset;
                    })
                    .attr('y', function (d) {
            ...
            svgSLA.selectAll('text.x')
                ...
                .attr({
                    'text-anchor': 'middle',
                    x: function (d, i) { return i * (wSLA / dataSLA.length) + ((wSLA / dataSLA.length - padding) / 2) + percentLabelOffset; },
            ...
            svgSFLY.selectAll('rect')
                ...
                .append('rect')
                    .attr('x', function (d, i) {    // d == data; i == index
                        return i * (wTime / timeseriesSFLY.length);
                    })
                    .attr('y', function (d) {
                        return h - (d[1] * yScaleTime) - fontSize - yOffset;
                    })
            ...
            svgSFLY.selectAll('text')
                ...
                .attr({
                    'text-anchor': 'middle',
                    x: function (d, i) { return i * (wTime / timeseriesSFLY.length) + (wTime / timeseriesSFLY.length - padding) / 2; },
